...
printLabelValue('Item', matrix.garmentType || '', s1X, s1Y);
  ...
  ''                  // ALTER = blank
    ...
    const rightBoxX = leftBoxX + leftBoxW + CM2;
    const rightBoxY = leftBoxY;
    const rightBoxW = W - CM2 - rightBoxX;
    const rightBoxHcalc = rightBoxH;
    doc.rect(rightBoxX, rightBoxY, rightBoxW, rightBoxHcalc);
    doc.setFont('helvetica', 'bold'); doc.setFontSize(12);
    doc.text('RATE LIST', rightBoxX + rightBoxW / 2, rightBoxY + 20, { align: 'center' });
    doc.setFont('helvetica', 'italic'); doc.setFontSize(11);
    doc.text('(paste the rate list here)', rightBoxX + rightBoxW / 2, rightBoxY + 42, { align: 'center' });
    ...
    (function drawSticker() {
      ...
      const minStickerY = afterTableY + 12;
